/*(function($) {
	...
	$.fn.tagit = function(options) {
		...
		$(this).click(function(e){
			if (e.target.tagName == 'A') {
				...
				$(e.target).parent().remove();
                                ...
                                {
                                    // If the current tag is not the tag to be removed
                                    if(tagList[i] != tag[1])
                                    {
                                        // If we are at the begining or if the tag to be removed is the first
                                        ...
                                        newTagList += tagList[i];
                                    }
                                 }
                                 $('#tagsValues').val(newTagList);
			}
			else {
		...
		function create_choice (value){
                    var attr = $('#tagsValues').val();
                    if(attr == "")
                        $('#tagsValues').val(value);
                    else
                        $('#tagsValues').val(attr+" "+value);
			var el = "";
